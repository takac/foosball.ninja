...
INSERT INTO game (winner, opponent, gamedate) VALUES
    (1, 2, datetime('2010-11-16 13:12:22')),
    (1, 2, datetime('2010-11-16 12:12:22')),
    (1, 2, datetime('2010-11-16 11:12:22')),
    (1, 2, datetime('2010-11-16 10:12:22')),
    (1, 2, datetime('2010-11-16 09:12:22')),
    (1, 2, datetime('2010-11-16 08:12:22')),
    (1, 2, datetime('2010-11-16 07:12:22')),
    (1, 2, datetime('2010-11-16 06:12:22')),
...
INSERT INTO game (winner, opponent, gamedate) VALUES
    (2, 1, datetime('2010-11-19 12:12:22')),
    (2, 1, datetime('2010-11-19 11:12:22')),
    (2, 1, datetime('2010-11-19 10:12:22')),
    (2, 1, datetime('2010-11-19 09:12:22')),
    (2, 1, datetime('2010-11-19 08:12:22')),
    (2, 1, datetime('2010-11-19 07:12:22')),
    (2, 1, datetime('2010-11-19 06:12:22')),
...
INSERT INTO game (winner, opponent, gamedate) VALUES
    (1, 3, datetime('2000-11-16 07:12:22')),
    (1, 3, datetime('2000-11-16 06:12:22')),
    (1, 3, datetime('2000-11-16 06:12:22')),
    (1, 3, datetime('2000-11-15 06:12:22')),
    (1, 3, datetime('2000-11-15 05:12:22')),
    (1, 3, datetime('2000-11-20 03:12:22')),
    (1, 3, datetime('2000-11-20 01:12:22')),
    (1, 3, datetime('2000-11-16 03:12:22')),
    (1, 3, datetime('2000-11-28 03:12:04')),
    (1, 3, datetime('2000-11-16 03:12:44'));
